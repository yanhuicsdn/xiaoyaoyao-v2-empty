  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-x-clip" style={{ background: 'var(--bg-page, hsl(var(--background)))' }}>
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse at 70% 20%, rgba(20,184,166,0.25) 0%, rgba(16,185,129,0.15) 40%, transparent 70%)',
          filter: 'blur(60px)',
        }}
      />
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10 md:gap-12">
            <div className="flex-shrink-0">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-lg font-bold text-brand-gradient">小药药AI Skill管理与分享</span>
              </div>
